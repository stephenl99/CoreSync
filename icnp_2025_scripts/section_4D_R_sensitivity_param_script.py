...
if len(sys.argv) < 2:
    print("usage: section_4D_R_sensitivity_param_script.py <policy>")
    sys.exit(1)
...
if POLICY.lower() == "static":
    ...
    CORESYNC_R = 5      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
elif POLICY.lower() == "coresync_10":
    SCHEDULER = "ias"
    OVERLOAD_ALG = "breakwater"
    CALADAN_INTERVAL = 5
    CALADAN_THRESHOLD = 5
    ...
    UTILIZATION_RANGE = False
    CORESYNC_ENABLE = True
    CORESYNC_R = 15      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
elif POLICY.lower() == "coresync_20":
    SCHEDULER = "ias"
    OVERLOAD_ALG = "breakwater"
    CALADAN_INTERVAL = 5
    CALADAN_THRESHOLD = 5
    ...
    print(f"{POLICY} has been chosen.")
elif POLICY.lower() == "coresync_100":
    SCHEDULER = "ias"
    OVERLOAD_ALG = "breakwater"
    CALADAN_INTERVAL = 5
    CALADAN_THRESHOLD = 5
