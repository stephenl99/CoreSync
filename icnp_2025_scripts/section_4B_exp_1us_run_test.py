...
if len(sys.argv) < 2:
    print("usage: section_4B_exp_1us_run_test.py <output_dir>")
    sys.exit(1)

# Directory to store the test results
OUTPUT_DIR = "{}/{}".format(sys.argv[1], "section_4B_exp_1us")
...
for policy in POLICIES:
    ...
    # Run the test case
    os.system("sudo ./section_4B_exp_1us_param_script.py {}".format(policy))
