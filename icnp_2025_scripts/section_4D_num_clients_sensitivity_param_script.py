...
if POLICY.lower() == "static":
    ...
    CORESYNC_R = (NUM_CONNS // 10) * 1      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
    ...
    UTILIZATION_RANGE = False
    CORESYNC_ENABLE = True
    CORESYNC_R = (NUM_CONNS // 10) * 2      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
    ...
    UTILIZATION_RANGE = False
    CORESYNC_ENABLE = True
    CORESYNC_R = (NUM_CONNS // 10) * 5      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
    ...
    UTILIZATION_RANGE = False
    CORESYNC_ENABLE = True
    CORESYNC_R = (NUM_CONNS // 10) * 10      # Derived from the number of flows
    print(f"{POLICY} has been chosen.")
else:
